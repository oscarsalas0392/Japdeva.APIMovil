...
namespace Japdeva.APIMovil.Usuarios.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        /// <param name="agregarRepository">Repository para agregar entidades</param>
        public WeatherForecastController(ILogger<WeatherForecastController> logger, IAgregarRepository agregarRepository)
        {
            _logger = logger;
