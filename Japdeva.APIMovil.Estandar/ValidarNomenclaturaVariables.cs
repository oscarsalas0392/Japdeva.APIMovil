...
namespace Japdeva.APIMovil.Estandar
{
    ...
    public class ValidarNomenclaturaVariables : DiagnosticAnalyzer
    {
        ...
        private const string FormatoMensaje = "La variable '{0}' debe seguir la convenci�n camelCase (ejemplo: '{1}')";
        private const string Descripcion = "Las variables locales y par�metros de m�todos deben usar la convenci�n camelCase (primera letra min�scula, palabras siguientes con primera letra may�scula) para mantener la consistencia del c�digo.";
        ...
        private static void AnalizarMetodo(SyntaxNodeAnalysisContext contexto)
        {
            ...
            // Validar par�metros del m�todo
            ValidarParametros(contexto, metodo.ParameterList);

            // Validar variables locales en el cuerpo del m�todo
            if (metodo.Body != null)
            {
            ...
            {
                // Para m�todos con expression body, no hay variables locales que validar
                return;
            }
        }
        ...
        private static void AnalizarConstructor(SyntaxNodeAnalysisContext contexto)
        {
            ...
            // Validar par�metros del constructor
        ...
        {
            // Excluir par�metros que comienzan con underscore (descartables)
            if (nombreParametro.StartsWith("_"))
                return true;

            // Excluir par�metros comunes de una sola letra (por convenci�n)
        ...
        private static bool EsNombreCamelCase(string nombre)
        {
            ...
            // Verificar que no sea todo min�sculas con n�meros (ej: "variable1")
            // debe tener al menos una may�scula despu�s de la primera letra si tiene m�s de una palabra
            return true;
        }
