...
namespace Japdeva.APIMovil.Estandar
{
    ...
    public class ValidarNomenclaturaConstantes : DiagnosticAnalyzer
    {
        ...
        private const string FormatoMensaje = "La constante '{0}' debe seguir la convenci�n SCREAMING_SNAKE_CASE (ejemplo: '{1}')";
        private const string Descripcion = "Las constantes deben usar la convenci�n SCREAMING_SNAKE_CASE (todas las letras en may�sculas separadas por guiones bajos) para distinguirlas claramente de otras variables.";
        ...
        private static void AnalizarCampo(SyntaxNodeAnalysisContext contexto)
        {
            ...
            // Analizar cada variable en la declaraci�n del campo
        ...
        private static bool EsNombreScreamingSnakeCase(string nombre)
        {
            ...
            // - Solo letras mayúsculas (incluyendo acentuadas), números y guiones bajos
