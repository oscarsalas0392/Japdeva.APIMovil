...
namespace Japdeva.APIMovil.Estandar
{
    ...
    public class ValidarNombreInterfazClase : DiagnosticAnalyzer
    {
        ...
        private const string TituloInterfaz = "Interfaz debe tener el mismo nombre que su implementaci�n con 'I' al frente";
        ...
        private const string DescripcionInterfaz = "Las interfaces deben tener el mismo nombre que las clases que las implementan, precedido por 'I', para mantener la correspondencia clara entre interfaz e implementaci�n.";
        ...
        private const string DescripcionClase = "Las clases deben tener el mismo nombre que las interfaces que implementan, sin el prefijo 'I', para mantener la correspondencia clara entre interfaz e implementaci�n.";
        ...
        private static void AnalizarCompilacionCompleta(CompilationAnalysisContext contexto)
        {
            ...
            // Validar nombres de interfaces bas�ndose en sus implementaciones
            foreach (var interfaz in interfaces)
            {
                ValidarNombreInterfaz(contexto, interfaz, clases);
            }

            // Validar nombres de clases bas�ndose en las interfaces que implementan
            ...
            InterfaceInfo interfaz, System.Collections.Generic.List<ClaseInfo> todasLasClases)
        {
            ...
            // Si hay m�ltiples implementaciones, tomar la primera como referencia
            ...
            ClaseInfo clase, System.Collections.Generic.List<InterfaceInfo> todasLasInterfaces)
        {
            ...
            {
                // Solo validar interfaces que empiecen con "I" seguido de may�scula
        ...
        private static bool EsInterfazEspecial(InterfaceInfo interfaz)
        {
            ...
            // Excluir interfaces gen�ricas complejas
        ...
        private static bool EsClaseEspecial(ClaseInfo clase)
        {
            ...
            if (clase.Sintaxis.BaseList != null)
            {
                ...
                {
                    var tipoString = tipo.ToString();
                    // Si no empieza con "I" y tiene may�scula despu�s, probablemente es una clase base
