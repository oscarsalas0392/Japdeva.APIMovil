...
{
    /// <summary>
    /// Servicio que notifica al usuario externo cuando su reclamo ha sido registrado exitosamente.
    /// Obtiene los datos del usuario y la plantilla en paralelo, construye el cuerpo del correo
    /// y lo publica en la cola de envío.
    /// </summary>
    public class NotificarUsuarioReclamoService : INotificarUsuarioReclamoService
    {
        private readonly ILogger<NotificarUsuarioReclamoService> _logger;
        ...
        private const string ID_PLANTILLA_RECLAMO = "2";
        ...
        /// <summary>
        /// Inicializa una nueva instancia de NotificarUsuarioReclamoService.
        /// </summary>
        ...
        public NotificarUsuarioReclamoService(
            ILogger<NotificarUsuarioReclamoService> logger,
        ...
        public async Task NotificarNuevoReclamoAsync(string traceId, long idReclamo, long idUsuarioExterno)
        {
            ...
            try
            {
                ...
                var tareaPlantilla = this._colaRpcService.EnviarYEsperarRespuestaAsync(
                    traceId, COLA_OBTENER_PLANTILLA, COLA_RESPUESTA, ID_PLANTILLA_RECLAMO, cts.Token);
