...
namespace Japdeva.APIMovil.Reclamos.Controllers
{
    ...
    public class DocumentoInternoController : Controller
    {
        ...
        public Task<IActionResult> EliminarDocumentoInterno([FromServices] IEliminarDocumentoInternoService eliminarDocumentoInternoService,
            [FromQuery(Name = "id-documento")] long idDocumento) =>
            eliminarDocumentoInternoService.EliminarDocumentoInternoAsync(HttpContext.TraceIdentifier, idDocumento);

        /// <summary>
        /// Obtiene los documentos internos asociados a un detalle de reclamo específico.
        /// </summary>
